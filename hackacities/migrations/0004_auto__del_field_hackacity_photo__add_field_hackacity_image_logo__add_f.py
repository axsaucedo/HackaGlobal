...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HackaCity.photo'
        db.delete_column(u'hackacities_hackacity', 'photo')

        # Adding field 'HackaCity.image_logo'
        db.add_column(u'hackacities_hackacity', 'image_logo',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'HackaCity.image_home'
        db.add_column(u'hackacities_hackacity', 'image_home',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'HackaCity.image_about'
        db.add_column(u'hackacities_hackacity', 'image_about',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'HackaCity.image_divider_1'
        db.add_column(u'hackacities_hackacity', 'image_divider_1',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'HackaCity.image_divider_2'
        db.add_column(u'hackacities_hackacity', 'image_divider_2',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'HackaCity.image_divider_3'
        db.add_column(u'hackacities_hackacity', 'image_divider_3',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'HackaCity.image_divider_4'
        db.add_column(u'hackacities_hackacity', 'image_divider_4',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'HackaCity.photo'
        db.add_column(u'hackacities_hackacity', 'photo',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100),
                      keep_default=False)

        # Deleting field 'HackaCity.image_logo'
        db.delete_column(u'hackacities_hackacity', 'image_logo')

        # Deleting field 'HackaCity.image_home'
        db.delete_column(u'hackacities_hackacity', 'image_home')

        # Deleting field 'HackaCity.image_about'
        db.delete_column(u'hackacities_hackacity', 'image_about')

        # Deleting field 'HackaCity.image_divider_1'
        db.delete_column(u'hackacities_hackacity', 'image_divider_1')

        # Deleting field 'HackaCity.image_divider_2'
        db.delete_column(u'hackacities_hackacity', 'image_divider_2')

        # Deleting field 'HackaCity.image_divider_3'
        db.delete_column(u'hackacities_hackacity', 'image_divider_3')

        # Deleting field 'HackaCity.image_divider_4'
        db.delete_column(u'hackacities_hackacity', 'image_divider_4')
    ...
    models = {
        ...
        u'hackacities.hackacity': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_about': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'image_divider_1': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'image_divider_2': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'image_divider_3': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'image_divider_4': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
