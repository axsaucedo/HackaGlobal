...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'hackaglobal_event', 'photo',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'hackaglobal_event', 'photo')
    ...
    models = {
        ...
        u'hackacities.hackacity': {
            ...
            'image_logo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
