...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.external'
        db.add_column(u'hackaglobal_event', 'external',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Event.photo'
        db.alter_column(u'hackaglobal_event', 'photo', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100))

    def backwards(self, orm):
        # Deleting field 'Event.external'
        db.delete_column(u'hackaglobal_event', 'external')


        # Changing field 'Event.photo'
        db.alter_column(u'hackaglobal_event', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
