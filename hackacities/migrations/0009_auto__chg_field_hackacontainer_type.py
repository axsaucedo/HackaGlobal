...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HackaContainer.type'
        db.alter_column(u'hackacities_hackacontainer', 'type', self.gf('django.db.models.fields.CharField')(max_length=2))

    def backwards(self, orm):

        # Changing field 'HackaContainer.type'
        db.alter_column(u'hackacities_hackacontainer', 'type', self.gf('django.db.models.fields.CharField')(max_length=1))
