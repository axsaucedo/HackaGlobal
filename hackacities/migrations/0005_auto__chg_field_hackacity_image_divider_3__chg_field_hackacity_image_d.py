...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HackaCity.image_divider_3'
        db.alter_column(u'hackacities_hackacity', 'image_divider_3', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'HackaCity.image_divider_1'
        db.alter_column(u'hackacities_hackacity', 'image_divider_1', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'HackaCity.image_about'
        db.alter_column(u'hackacities_hackacity', 'image_about', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'HackaCity.image_divider_4'
        db.alter_column(u'hackacities_hackacity', 'image_divider_4', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'HackaCity.image_divider_2'
        db.alter_column(u'hackacities_hackacity', 'image_divider_2', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'HackaCity.image_home'
        db.alter_column(u'hackacities_hackacity', 'image_home', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'HackaCity.image_divider_3'
        db.alter_column(u'hackacities_hackacity', 'image_divider_3', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100))

        # Changing field 'HackaCity.image_divider_1'
        db.alter_column(u'hackacities_hackacity', 'image_divider_1', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100))

        # Changing field 'HackaCity.image_about'
        db.alter_column(u'hackacities_hackacity', 'image_about', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100))

        # Changing field 'HackaCity.image_divider_4'
        db.alter_column(u'hackacities_hackacity', 'image_divider_4', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100))

        # Changing field 'HackaCity.image_divider_2'
        db.alter_column(u'hackacities_hackacity', 'image_divider_2', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100))

        # Changing field 'HackaCity.image_home'
        db.alter_column(u'hackacities_hackacity', 'image_home', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100))
