...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for lang in orm.Languages.objects.all():
            code = lang.country_code
            lang.country = orm.Countries.objects.get(code=code)
            lang.save()

        for city in orm.Cities.objects.all():
            code = city.country_code
            city.country = orm.Countries.objects.get(code=code)
            city.save()
