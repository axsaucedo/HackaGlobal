...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'hackaglobal_event', 'website', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Event.website'
        db.alter_column(u'hackaglobal_event', 'website', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
