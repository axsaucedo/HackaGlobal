...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'accounts_userprofile', 'facebook',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.title'
        db.add_column(u'accounts_userprofile', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.description'
        db.add_column(u'accounts_userprofile', 'description',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'accounts_userprofile', 'facebook')

        # Deleting field 'UserProfile.title'
        db.delete_column(u'accounts_userprofile', 'title')

        # Deleting field 'UserProfile.description'
        db.delete_column(u'accounts_userprofile', 'description')
